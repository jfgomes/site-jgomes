...
class CaseStudiesService
{
    ...
    private function convertDirName(string $name): string
    {
        return match ($name)
        {
            ...
            "7rate-limit"         => "👮‍♀️Requests limit per route per user + rate limit security with Throttle ##DONE##",
            ...
            "9.5caches"           => "💿 Backend cache system implementation for load balanced with multiple frontends ##STARTED_NOT_DONE##",
