...
class CaseStudiesService
{
    ...
    private function convertDirName(string $name): string
    {
        return match ($name)
        {
            ...
            "2.3wms"              => "📩 Website message service ##STARTED_NOT_DONE##",
            ...
            "9.6auth2"            => "🔑 Implementation of OAuth2 with Passport + Token/Refresh token management ##NOT_STARTED##",
            "9.7areas_for_admins" => "🔐 Special routes only accessible for some users ##NOT_STARTED##",
            "9.8dashboard"        => "🔐 Dashboard with the system status accessible only for admins ##NOT_STARTED##",
            default => $name,
        };
    }
}
