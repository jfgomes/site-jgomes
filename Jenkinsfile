            ...
            steps {
                script {
                    sshagent(credentials: ['5f9bd247-5605-4b42-9bb9-c8da86395696']) {
                        ...
                        sh 'ssh -o StrictHostKeyChecking=no jgomes@94.63.32.148 \'cd /home/jgomes/my/jgomes/site-jgomes && composer update && php artisan migrate && php artisan route:clear && php artisan config:clear && php artisan cache:clear \''
