            ...
            steps {
                script {
                    sshagent(credentials: ['5f9bd247-5605-4b42-9bb9-c8da86395696']) {
                        ...
                        sh 'ssh -o StrictHostKeyChecking=no jgomes@94.63.32.148 \'cd /home/jgomes/my/jgomes/site-jgomes && APP_ENV=prod composer update && APP_ENV=prod php artisan migrate && php artisan route:clear && php artisan config:clear && php artisan cache:clear \''
