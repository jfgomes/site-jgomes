...
if (empty($MYREQUEST['OB']))    $MYREQUEST['OB']=1;
...
// create menu entry
function menu_entry($ob, $title, $aux=null) {
...
EOB;
echo
menu_entry(OB_HOST_STATS,'View Host Stats',$MYREQUEST),
menu_entry(OB_USER_CACHE,'User Cache Entries',$MYREQUEST),
